...
// 能量水平选项
const energyOptions = [
  { value: 'high', label: '精力充沛', icon: '⚡' },
  { value: 'medium', label: '一般', icon: '⚡' },
  { value: 'low', label: '疲惫', icon: '⚡' },
]
...
const handleChooseImage = () => {
  uni.chooseImage({
    count: 1,
    success: (res) => {
      lunchImage.value = res.tempFilePaths[0]
    },
  })
}
      ...
      <view class="upload-section">
        <view class="upload-box" @tap="handleChooseImage">
          ...
          <view v-else class="upload-placeholder">
            ...
            <text class="upload-text">上传午餐图片</text>
          </view>
        </view>
      </view>
      ...
      <view class="mood-section">
        ...
        <view class="mood-list">
          <view
            ...
            :key="option.value"
            class="mood-item"
            :class="{ active: energy === option.value }"
            @tap="energy = option.value"
          >
            <text class="mood-icon">{{ option.icon }}</text>
            <text class="mood-label">{{ option.label }}</text>
          </view>
